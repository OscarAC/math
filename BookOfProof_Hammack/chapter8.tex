...
\begin{problems}
    ...
    \problem Prove that $\bigcap\limits_{x\in\mathbb{R}} [3-x^2, 5+x^2] = [3,5]$.
    \begin{proof}
        First we prove that $[3,5] \subseteq \bigcap\limits_{x\in\mathbb{R}}[3-x^2,5+x^2]$.\\ 
        Take any $a \in [3,5]$.
        Since $x^2 \geq 0$ for every $x \in \mathbb{R}$, it follows that $3-x^2 \leq 3 \leq a$ and $a \leq 5 \leq 5+x^2$.
        Thus $3-x^2 \leq a \leq 5+x^2$, so $a \in [3-x^2, 5+x^2]$ for every $x \in \mathbb{R}$.
        Therefore $[3,5] \subseteq \bigcap\limits_{x\in\mathbb{R}}[3-x^2,5+x^2]$.

        Conversely, we prove $\bigcap\limits_{x\in\mathbb{R}}[3-x^2,5+x^2] \subseteq [3,5]$.\\ 
        Since $0 \in \mathbb{R}$, one of the intervals in the intersection is $[3-0^2, 5+0^2] = [3,5]$.
    Because an intersection must be contained in each set being intersection, we have $\bigcap\limits_{x\in\mathbb{R}}[3-x^2,5+x^2] \subseteq [3,5]$.
    \end{proof}

    \problem Prove $\set{4k + 5 : k \in \mathbb{Z}} = \set{4k+1 : k \in \mathbb{Z}}$.
    \begin{proof}
        First we show $\set{4k+5 : k \in \mathbb{Z}} \subseteq \set{4k+1 : k \in \mathbb{Z}}$.\\ 
        Assume $a \in \set{4k+5 : k \in \mathbb{Z}}$.
        This means $a = 4k + 5$ for some $k \in \mathbb{Z}$.
        Thus $a = 4(k+1) + 1$.
        Since $(k+1) \in \mathbb{Z}$, we have $a \in \set{4k+1 : k \in \mathbb{Z}}$.
        Therefore, $\set{4k+5 : k \in \mathbb{Z}} \subseteq \set{4k+1 : k \in \mathbb{Z}}$.

        Now we prove $\set{4k+1 : k \in \mathbb{Z}} \subseteq \set{4k+5 : k \in \mathbb{Z}}$.\\ 
        Assume $a \in \set{4k+1 : k \in \mathbb{Z}}$.
        This means $a = 4k+1$ for some $k \in \mathbb{Z}$.
        Thus $a = 4(k-1)+5$.
        Since $(k-1) \in \mathbb{Z}$, we have $a \in \set{4k+5 : k \in \mathbb{Z}}$.
        Therefore, $\set{4k+1 : k \in \mathbb{Z}} \subseteq \set{4k+5 : k \in \mathbb{Z}}$.
