...
\begin{problems}
    ...
    As $b$ ranges over $\mathbb{N}$, the first line produces exactly the integers $1,2,3,\dots$, and the second produces exactly $0,-1,-2,\dots$, that is, the integers less than or equal to 0.
