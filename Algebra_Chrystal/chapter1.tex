...
\begin{problems}[from=1,step=1]
    ...
    \answer 
    \begin{parts}
        \item $(a+b) \times (a+b) = a^2+2ab+b^2$.
        \item $(a-b)\times(a+b) = a^2-b^2$.
        \item $(3a-6b) \times (3a+6b) = 9a^2 - 36b^2$.
        \item $(\tfrac{1}{3}a-\tfrac{1}{6}b)\times(\tfrac{1}{3}a+\tfrac{1}{6}b) = \tfrac{1}{9}a^2-\tfrac{1}{36}b^2$
    \end{parts}
